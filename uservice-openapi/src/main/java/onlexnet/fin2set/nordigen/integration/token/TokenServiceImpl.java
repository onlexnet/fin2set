...
public class TokenServiceImpl implements TokenService {
    ...
    public SpectacularJWTObtain getTokens() {
        JWTObtainPairRequest jwtObtainPairRequest = new JWTObtainPairRequest(secretId, secretKey);
    ...
    public SpectacularJWTRefresh refreshAccessToken() {
        JWTRefreshRequest jwtRefreshRequest = new JWTRefreshRequest(refreshToken);
